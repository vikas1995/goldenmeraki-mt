...
export class CategoriesService {
  ...
  async remove(id: string): Promise<{ message: string }> {
    ...
    if (category.image && (category.image.startsWith('https://goldenmerakigems.com/Images/categories/') || category.image.startsWith('https://goldenmerakigems.com/goldenmerakigems-images/categories/') || category.image.startsWith('https://goldenmerakigems.com/goldenmerakigems-images/category/'))) {
      try {
        const filename = path.basename(category.image);
        const filePath = path.join(process.cwd(), 'public_html', 'goldenmerakigems-images', 'categories', filename);
  ...
  async uploadImage(id: string, file: Express.Multer.File): Promise<CategoryDocument> {
    ...
    const uploadDir = path.join(process.cwd(), 'public_html', 'goldenmerakigems-images', 'categories');
